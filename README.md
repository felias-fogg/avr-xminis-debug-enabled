...
After installing this core, you can program and upload Arduino sketches immediately. No preparations are necessary to begin debugging—no solder bridges to cut or confusing fuses to set. And entering and leaving debugWIRE mode is fully automated without power-cycling and typing any funny commands.
